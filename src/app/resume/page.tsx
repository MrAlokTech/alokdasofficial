  ...
  return (
    <div className="py-10 md:py-14 bg-secondary/30 print:bg-white print:py-0 transition-colors">
      <div className="container mx-auto px-4 sm:px-6 max-w-4xl space-y-8">
        ...
        <div className="no-print rounded-2xl border border-border/80 bg-card p-5 sm:p-6 shadow-[0_1px_3px_rgba(0,0,0,0.02)] flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-2.5 flex-shrink-0">
            <button
              onClick={handlePrint}
              className="inline-flex items-center gap-2 rounded-xl bg-primary px-5 py-2.5 text-[13px] font-medium text-primary-foreground shadow-sm hover:brightness-105 active:brightness-95 transition-all cursor-pointer min-h-[44px]"
            >
        ...
        <div className="resume-sheet rounded-2xl border border-border/80 bg-card p-8 sm:p-14 shadow-[0_1px_4px_rgba(0,0,0,0.03)] text-foreground space-y-8 print:p-0 print:border-none print:shadow-none">
          ...
          <div className="border-b border-border/80 pb-6 space-y-3">
            <div className="flex flex-col sm:flex-row sm:items-baseline justify-between gap-2">
              ...
              <span className="text-[12px] font-mono font-medium text-emerald-700 dark:text-emerald-400">
                M.Sc. Chemistry &middot; RTV Hojai
              </span>
            </div>
            ...
            <div className="flex flex-wrap items-center gap-y-1.5 gap-x-4 text-[12px] text-muted-foreground">
              ...
              <span>&bull;</span>
              <a
                href={personalData.contact.website}
                className="flex items-center gap-1.5 hover:text-foreground hover:underline"
              >
          ...
          <section className="space-y-2">
            <h3 className="text-[11px] font-bold uppercase tracking-wider text-emerald-700 dark:text-emerald-400 border-b border-border/80 pb-1">
              Career Objective
            </h3>
            ...
            <div className="space-y-3 text-[13px]">
              {educationData.map((edu) => (
                ...
                >
                  ...
                  {/* <div className="flex items-center gap-3 text-muted-foreground sm:text-right font-mono text-[11px] flex-shrink-0"> */}
                  <div className="items-center gap-3 text-muted-foreground sm:text-right font-mono text-[11px] flex-shrink-0">
          ...
          <section className="space-y-3">
            ...
            <div className="space-y-2 text-[13px]">
              ...
              <ul className="space-y-1 text-muted-foreground pl-4 list-disc leading-relaxed text-[12px]">
                <li>
          ...
          <section className="space-y-3">
            <h3 className="text-[11px] font-bold uppercase tracking-wider text-primary border-b border-border/80 pb-1">
            ...
            <div className="space-y-2 text-[12px]">
              <p className="text-muted-foreground">
                ...
                Git/GitHub, Material Design, Google Play Console.
              </p>
              <div className="space-y-1.5 pt-1">
                ...
                <div>
                  ...
                  <span className="text-muted-foreground">
                    {" "}
                    (Web App at alomolecule.web.app): Built scientific
                    calculation tool with chemical equation balancing and
          ...
          <section className="space-y-2">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-2 text-[12px] text-muted-foreground">
              <div>
                ...
                <span>Native (Read, Write, Speak)</span>
              </div>
              <div>
                <strong className="text-foreground block">English</strong>
                <span>Fluent (Read, Write, Speak)</span>
              </div>
              <div>
          ...
          <section className="pt-6 border-t border-border/80 space-y-4">
            ...
            <div className="flex items-end justify-between text-[12px] pt-2">
              <div>
                <p className="text-muted-foreground">
                  Location:{" "}
