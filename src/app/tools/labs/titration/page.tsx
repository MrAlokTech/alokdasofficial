...
import { TitrationLab } from "@/components/labs/titration-lab";
...
export const metadata: Metadata = {
  title: "Acid–Base Titration Virtual Lab & Curve Simulator | Alok Das",
  description:
    "Interactive acid-base titration simulation with volumetric buret delivery, dynamic pH titration curves, and indicator color transitions for strong and weak acids.",
  alternates: {
    canonical: "https://alokdasofficial.in/tools/labs/titration",
  },
  openGraph: {
    title: "Acid–Base Titration Virtual Lab & Curve Simulator | Alok Das",
    description:
      "Simulate volumetric titrations, detect stoichiometric equivalence points, and plot pH curves in real time.",
    url: "https://alokdasofficial.in/tools/labs/titration",
    type: "website",
  },
};

export default function TitrationLabPage() {
  const lab = virtualLabsData.find((l) => l.id === "titration")!;
