...
export const resumeData: ResumeData = {
  ...
  firstName: "Alok",
  lastName: "Das",
  currentPosition: "M.Sc. Chemistry",
  collegeShort: "RTV Hojai, Assam",
  collegeFull: "Rabindranath Thakur Viswavidyalaya, Hojai, Assam",
  careerObjective: "Chemistry graduate with an ongoing M.Sc. curriculum and practical dissertation research experience, seeking an entry-level position as a Laboratory Assistant, Project Assistant, or Quality Control (QC) Analyst. Committed to applying analytical methodologies, volumetric techniques, and structured GLP documentation to advance laboratory and quality operations.",
  location: {
    city: "Hojai",
    state: "Assam",
    country: "India",
  ...
  contact: {
    ...
    websiteClean: "alokdasofficial.in",
  },
  social: {
